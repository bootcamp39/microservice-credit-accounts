package com.nttdata.microservice.bankcreditaccounts.kafka.producer;
...
@Component
public class ReportTransactionMessagePublish {
	
	public static Logger log = Logger.getLogger(ReportTransactionMessagePublish.class);
	...
	public ListenableFuture<SendResult<String, String>> sendMessage(ReportTransactionDto reportTransactionDto) throws JsonProcessingException {
	
		String key = reportTransactionDto.getPersonCode();
		String value = objectMapper.writeValueAsString(reportTransactionDto);
